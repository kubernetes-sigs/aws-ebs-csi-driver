...
|----------------|---------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| v1.61.0        | registry.k8s.io/provider-aws/aws-ebs-csi-driver:v1.61.0                                           | public.ecr.aws/ebs-csi-driver/aws-ebs-csi-driver:v1.61.0                      |
| v1.60.1        | registry.k8s.io/provider-aws/aws-ebs-csi-driver:v1.60.1                                           | public.ecr.aws/ebs-csi-driver/aws-ebs-csi-driver:v1.60.1                      |
