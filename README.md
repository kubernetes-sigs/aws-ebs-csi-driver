...
|----------------|---------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| v1.66.0        | registry.k8s.io/provider-aws/aws-ebs-csi-driver:v1.66.0                                           | public.ecr.aws/ebs-csi-driver/aws-ebs-csi-driver:v1.66.0                      |
| v1.65.0        | registry.k8s.io/provider-aws/aws-ebs-csi-driver:v1.65.0                                           | public.ecr.aws/ebs-csi-driver/aws-ebs-csi-driver:v1.65.0                      |
...
|---------------|---------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| 2.66.0        | registry.k8s.io/provider-aws/charts/aws-ebs-csi-driver:2.66.0                                     | public.ecr.aws/ebs-csi-driver/charts/aws-ebs-csi-driver:2.66.0                       |
