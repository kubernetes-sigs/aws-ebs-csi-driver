...
require (
	...
	github.com/kubernetes-sigs/aws-ebs-csi-driver v1.64.0
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/sagemaker v1.269.0 // indirect
...
replace (
	...
	k8s.io/node-api => k8s.io/node-api v0.37.0
