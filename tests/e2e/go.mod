...
require (
	...
	github.com/kubernetes-sigs/aws-ebs-csi-driver v1.63.1
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/sagemaker v1.267.0 // indirect
...
replace (
	...
	k8s.io/node-api => k8s.io/node-api v0.36.3
