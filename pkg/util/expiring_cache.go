...
// NewExpiringCache returns a new ExpiringCache
// for a given KeyType, ValueType, and expiration delay
func NewExpiringCache[KeyType comparable, ValueType any](expirationDelay time.Duration) ExpiringCache[KeyType, ValueType] {
