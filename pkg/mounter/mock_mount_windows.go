...
func (m *MockProxyMounter) FormatAndMount(source, target, fstype string, options []string) error {
	m.ctrl.T.Helper()
...
func (mr *MockProxyMounterMockRecorder) FormatAndMount(source, target, fstype, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FormatAndMount", reflect.TypeOf((*MockProxyMounter)(nil).FormatAndMount), source, target, fstype, options)
}
