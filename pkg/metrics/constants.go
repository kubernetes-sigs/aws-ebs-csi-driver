...
const (
	...
	APIRequestDurationHelpText            = "Duration by request type in seconds"
	APIRequestErrorsHelpText              = "Total number of errors by error code and request type"
	APIRequestThrottlesHelpText           = "Total number of throttled requests per request type"
