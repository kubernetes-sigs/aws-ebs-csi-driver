...
func (c *awsTagging) readRepairClusterTags(client *ec2.EC2, resourceID string, lifecycle ResourceLifecycle, additionalTags map[string]string, observedTags []*ec2.Tag) error {
...
func (t *awsTagging) createTags(client *ec2.EC2, resourceID string, lifecycle ResourceLifecycle, additionalTags map[string]string) error {
