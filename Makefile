...
###
### How to use this Makefile is documented in docs/makefile.md
###
...
## Top level targets
# Targets intended to be executed by humans via `make target`
...
.PHONY: tools
tools: bin/aws bin/ct bin/eksctl bin/ginkgo bin/golangci-lint bin/helm bin/kops bin/kubetest2 bin/mockgen

.PHONY: update
update: update/gofmt update/kustomize update/mockgen update/gomod
