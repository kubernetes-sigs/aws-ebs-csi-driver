...
.PHONY: test
test:
	go test -v -race github.com/kubernetes-sigs/ebs-csi-driver/pkg/...

.PHONY: test-sanity
test-sanity:
	go test -v github.com/kubernetes-sigs/ebs-csi-driver/tests/sanity/...

.PHONY: test-e2e
test-e2e:
	go test -v github.com/kubernetes-sigs/ebs-csi-driver/tests/e2e/...
