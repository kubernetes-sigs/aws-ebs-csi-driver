...
The EBS CSI Driver comes with a Makefile that can be used to develop, build, test, and release the driver. This file documents the available targets intended for use by humans, the parameters they support, and common usage scenarios.

## Prerequisites

The `Makefile` and associated tooling assume you already have the following tools installed:
