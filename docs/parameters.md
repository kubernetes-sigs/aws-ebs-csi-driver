...
* `gp3` is currently not supported on First Generation Outpost Racks. As the driver defaults to gp3 when no type is passed. Outpost customers using First Generation Outposts need to specify a different type for their volumes.
