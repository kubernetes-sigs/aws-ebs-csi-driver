...
Repository: https://gallery.ecr.aws/ebs-csi-driver/aws-ebs-csi-driver  
Latest Image: `public.ecr.aws/ebs-csi-driver/aws-ebs-csi-driver:v1.6.2`
...
|---------------------------|--------------------------------------------------|-----------------------------------------------------------------------------|
|v1.6.2                     |                                                  | public.ecr.aws/ebs-csi-driver/aws-ebs-csi-driver:v1.6.2                     |
