...
**Note: If you are using a CNI plugin that adds extra routing layers, such as eBPF overlays, a hop limit of 2 may lead to dropped packets. A hop limit of 3 or higher is often required for the IMDS return packets to reach the pods.
